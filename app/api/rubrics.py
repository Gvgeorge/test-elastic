...
def get_rubrics(service: RubricService = Depends()):
...
def add_rubric(
    ...
    return service.create(rubric_data)
...
def update_rubric(
    ...
    return service.update(rubric_id, rubric_data)
